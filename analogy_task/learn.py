...
from models import CP, ComplEx, Analogy, BiComplex, read_txt
...
models = ['CP', 'ComplEx', 'Analogy', 'BiComplex']
parser.add_argument(
...
parser.add_argument(
    '--optimizer', choices=optimizers, default='Adam',
...
parser.add_argument(
    '--decay2', default=0.98, type=float,
...
model = {
    ...
    'BiComplex': lambda: BiComplex(dataset.get_shape(), args.rank, args.init, args.finetune),
}[args.model]()
